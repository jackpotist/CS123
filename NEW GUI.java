    ...
    public NewClass() throws ClassNotFoundException, SQLException {
       ...
       populate();
        ...
        try {
            ...
            DefaultTableModel dtm3 = execQuer2(user,pass,"select * from employee");
            ItemTable2.setModel(dtm2);
            MaterialTable1.setModel(dtm2);
            WarehouseTable.setModel(dtm2);
            EmployeesTable.setModel(dtm3);
...
"		);";
    ...
    private void WarehouseTableMouseClicked(java.awt.event.MouseEvent evt) {                                            
        try{            
            ...
            if(rr.next()){
                String add1 = rr.getString("material_name");
                txt_employee_id.setText(add1);
                String add2 = rr.getString("quantity");
    ...
    private void EmployeesTableMouseClicked(java.awt.event.MouseEvent evt) {                                            
        try{
            ...
            String stringcon = "jdbc:mysql://localhost:3306/jcarl";//databaseName=travel;user=root;password=12345
            Connection con = DriverManager.getConnection(stringcon,"root","12345");
            String sql = "Select employee_name, rate from employee where employee_id='"+Table_click+"' ";
            Statement pst= con.prepareStatement(sql);   
            ResultSet rr = pst.executeQuery(sql);
            if(rr.next()){
                String add1 = rr.getString("employee_name");
                txt_employee_name.setText(add1);
                String add2 = rr.getString("rate");
